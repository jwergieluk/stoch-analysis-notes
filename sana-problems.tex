...
Show that
\begin{enumerate}
    \item $T_B$ is a stopping time. 
    \item $T_B$ is an optional time. 
\end{enumerate}
...
\problem{Bounded local martingales are true martingales.} Local martingales
...
\problem{Martingales and completition of the stochastic basis.} Let $X$ be a
